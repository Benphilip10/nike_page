...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className='mt-10 text-8xl font-palanquin max-sm:text-[72px] font-bold max-sm:leading-[1.2]'>
      <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10'>The New Arrival</span>
      <br/>
      <span className='text-coral-red inline-block mt-3'>Nike</span> Shoes
      </h1>
      <p className='text-slate-gray text-lg font-montserrat leading-8 mt-6 mb-10 sm:max-w-sm:'>Discover stylish Nike arrivals, quality comfort and innovation for your active life.</p>
      ...
      <div className='relative flex justify-center items-center flex-1 xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-center'>
          <img
            src={bigShoeImage}
            alt='shoe-collection'
            width={500}
